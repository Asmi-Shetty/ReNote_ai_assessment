...
def not_found_node(state: State):
    """
    Handle the case where the answer is not found in the documents after retries.
    """
    return {
        "messages": [AIMessage(content="I could not find the answer to your question in the uploaded documents. Please try rephrasing or asking about something else.")]
    }
