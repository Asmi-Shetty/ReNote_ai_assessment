    ...
    if uploaded_file:
        ...
        if file_description:
            if file_key not in st.session_state.uploaded_files:
                ...
                success = document_upload_rag(uploaded_file, file_description, st.session_state.get("jwt_token", ""))
                if success:
...
if user_input:
    ...
    response = query_backend(user_input, session_id, st.session_state.get("jwt_token", ""))
